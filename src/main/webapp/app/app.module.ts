...
import { LmsCoreModule } from 'app/core';
...
@NgModule({
  ...
  declarations: [JhiMainComponent, NavbarComponent, ErrorComponent, PageRibbonComponent, ActiveMenuDirective, FooterComponent, FileUploadComponent,
    FileSelectDirective],
  providers: [
    {
