...
describe('Service Tests', () => {
  describe('Reponse Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Reponse(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Reponse', async () => {
      ...
      it('should update a Reponse', async () => {
        const returnedFromService = Object.assign(
          {
            contenuReponse: 'BBBBBB'
          },
          elemDefault
        );
      ...
      it('should return a list of Reponse', async () => {
        const returnedFromService = Object.assign(
          {
            contenuReponse: 'BBBBBB'
          },
