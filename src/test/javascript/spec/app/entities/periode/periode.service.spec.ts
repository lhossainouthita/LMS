...
describe('Service Tests', () => {
  describe('Periode Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(PeriodeService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Periode(0, currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Periode', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            dateDebut: currentDate.format(DATE_FORMAT),
      ...
      it('should update a Periode', async () => {
        const returnedFromService = Object.assign(
          {
            dateDebut: currentDate.format(DATE_FORMAT),
            dateFin: currentDate.format(DATE_FORMAT)
      ...
      it('should return a list of Periode', async () => {
        const returnedFromService = Object.assign(
          {
            dateDebut: currentDate.format(DATE_FORMAT),
            dateFin: currentDate.format(DATE_FORMAT)
      ...
      it('should delete a Periode', async () => {
