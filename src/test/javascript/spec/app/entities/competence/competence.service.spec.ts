...
describe('Service Tests', () => {
  describe('Competence Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Competence(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Competence', async () => {
        const returnedFromService = Object.assign(
          {
            codeCompetence: 'BBBBBB',
            intituleCompetence: 'BBBBBB',
            descriptionCompetence: 'BBBBBB'
          },
          elemDefault
        );
      ...
      it('should return a list of Competence', async () => {
        const returnedFromService = Object.assign(
          {
            codeCompetence: 'BBBBBB',
            intituleCompetence: 'BBBBBB',
